...
let firstItem = document.querySelector('.carousel__item:first-child');
let lastItem = document.querySelector('.carousel__item:last-child');
// JSON
const apiUrl =
...
function carousel() {
  async function getData() {
    ...
    firstItem = document.querySelector('.carousel__item:first-child');
    lastItem = document.querySelector('.carousel__item:last-child');
